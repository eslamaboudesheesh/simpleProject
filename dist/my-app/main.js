...
module.exports = "<kendo-grid\r\n        [data]=\"gridData\"\r\n        [pageSize]=\"state.take\"\r\n        [skip]=\"state.skip\"\r\n        [sort]=\"state.sort\"\r\n        [filter]=\"state.filter\"\r\n        [sortable]=\"false\"\r\n        [pageable]=\"true\"\r\n        [filterable]=\"false\"\r\n        (dataStateChange)=\"dataStateChange($event)\"\r\n    >\r\n    <kendo-grid-column field=\"ProductID\" title=\"ID\" width=\"40\" [filterable]=\"false\">\r\n    </kendo-grid-column>\r\n    <kendo-grid-column field=\"ProductName\" title=\"Product Name\" >\r\n    </kendo-grid-column>\r\n    <kendo-grid-column field=\"FirstOrderedOn\" title=\"First Ordered On\" width=\"240\" filter=\"date\" format=\"{0:d}\" [filterable]=\"false\">\r\n    </kendo-grid-column>\r\n    <kendo-grid-column field=\"UnitPrice\" title=\"Unit Price\" width=\"180\" filter=\"numeric\" format=\"{0:c}\" [filterable]=\"false\">\r\n    </kendo-grid-column>\r\n    \r\n    </kendo-grid>\r\n"
...
/* harmony import */ var _stores_my_service_service__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./stores/my-service.service */ "./src/app/stores/my-service.service.ts");
...
var AppComponent = /** @class */ (function () {
    function AppComponent(MyServiceService) {
        ...
        this.gridData = Object(_progress_kendo_data_query__WEBPACK_IMPORTED_MODULE_1__["process"])(_products__WEBPACK_IMPORTED_MODULE_2__["sampleProducts"], this.state);
    }
    AppComponent.prototype.ngOnInit = function () { this.getdata(); };
    AppComponent.prototype.dataStateChange = function (state) {
        this.state = state;
        this.gridData = Object(_progress_kendo_data_query__WEBPACK_IMPORTED_MODULE_1__["process"])(_products__WEBPACK_IMPORTED_MODULE_2__["sampleProducts"], this.state);
    };
    AppComponent.prototype.getdata = function () {
        this.MyServiceService.GetAgents().subscribe(function (data) {
            console.log(data);
        });
    };
    AppComponent = __decorate([
        ...
        __metadata("design:paramtypes", [_stores_my_service_service__WEBPACK_IMPORTED_MODULE_3__["MyServiceService"]])
    ], AppComponent);
    return AppComponent;
}());
...
/* harmony import */ var _progress_kendo_angular_grid__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! @progress/kendo-angular-grid */ "./node_modules/@progress/kendo-angular-grid/dist/fesm5/index.js");
/* harmony import */ var _app_component__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./app.component */ "./src/app/app.component.ts");
/* harmony import */ var _angular_router__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! @angular/router */ "./node_modules/@angular/router/fesm5/router.js");
/* harmony import */ var _stores_store_store_component__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./stores/store/store.component */ "./src/app/stores/store/store.component.ts");
/* harmony import */ var _stores_stores_component__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./stores/stores.component */ "./src/app/stores/stores.component.ts");
var __decorate = (undefined && undefined.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var routes = [
    { path: 'stores', component: _app_component__WEBPACK_IMPORTED_MODULE_5__["AppComponent"] },
...
var AppModule = /** @class */ (function () {
    ...
    AppModule = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["NgModule"])({
            ...
            declarations: [
                _app_component__WEBPACK_IMPORTED_MODULE_5__["AppComponent"],
                _stores_store_store_component__WEBPACK_IMPORTED_MODULE_7__["StoreComponent"],
                _stores_stores_component__WEBPACK_IMPORTED_MODULE_8__["StoresComponent"]
            ],
            imports: [
...
/***/ "./src/app/stores/my-service.service.ts":
/*!**********************************************!*\
  !*** ./src/app/stores/my-service.service.ts ***!
  \**********************************************/
...
var MyServiceService = /** @class */ (function () {
    ...
    MyServiceService.prototype.GetAgents = function () {
        return this.http.get("http://localhost:8000/api/products", {}).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["map"])(function (response) {
            return response;
        }));
    };
...
/***/ "./src/app/stores/store/store.component.css":
/*!**************************************************!*\
  !*** ./src/app/stores/store/store.component.css ***!
  \**************************************************/
/*! no static exports found */
...
module.exports = "\n/*# sourceMappingURL=data:application/json;base64,eyJ2ZXJzaW9uIjozLCJzb3VyY2VzIjpbXSwibmFtZXMiOltdLCJtYXBwaW5ncyI6IiIsImZpbGUiOiJzcmMvYXBwL3N0b3Jlcy9zdG9yZS9zdG9yZS5jb21wb25lbnQuY3NzIn0= */"

/***/ }),

/***/ "./src/app/stores/store/store.component.html":
/*!***************************************************!*\
  !*** ./src/app/stores/store/store.component.html ***!
  \***************************************************/
/*! no static exports found */
...
var StoreComponent = /** @class */ (function () {
    ...
    StoreComponent = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Component"])({
            selector: 'app-store',
            template: __webpack_require__(/*! ./store.component.html */ "./src/app/stores/store/store.component.html"),
            styles: [__webpack_require__(/*! ./store.component.css */ "./src/app/stores/store/store.component.css")]
        }),
...
module.exports = __webpack_require__(/*! C:\Users\t-emhussein\Downloads\teeeeeest\src\main.ts */"./src/main.ts");
